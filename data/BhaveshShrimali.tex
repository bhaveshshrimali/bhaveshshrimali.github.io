...
homogenization; asymptotic methods; numerical analysis; high performance computing;\\ variational models of fracture; finite element method
...
\begin{minipage}[t]{0.85\linewidth}
	...
	\begin{itemize}[itemsep=-1pt]
		...
		\item {\bf CEE 471: Structural Mechanics*}: List of teachers ranked excellent by UIUC. \hfill [\textsl{Fall '17, '18, '19}]
...
\begin{minipage}[t]{0.85\linewidth}
	...
	\begin{itemize}[itemsep=-1pt, label={}]
		...
		\item {\bf FE Code: }FEniCS, Firedrake, Abaqus
...
\vspace{-1.5em}
\begin{itemize}[itemsep=1pt, label={}]
	\item {\bf Technische Universit\"{a}t Braunschweig}\hfill [\textsl{Summer 2014}]\\
	...
	\item {\bf Hong Kong University of Science and Technology}\hfill [\textsl{Summer 2013}]\\
